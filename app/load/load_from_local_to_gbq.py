...
def main(file_path,bucket_name,dataset_id,table_id
    ...
    gs_uri=upload_to_gcs(serviceAccountFileName,file_path,bucket_name,make_blob_public,remove_local_file)
    
    transfer_to_gbq(serviceAccountFileName,dataset_id,gs_uri,table_id,source_format,autodetect,partitioning_field_name)